...
const factory = Thumb => {
  class Switch extends Component {
    ...
    render() {
      ...
      return (
        <label data-mymoid="switch" className={_className}>
          {this.props.leftLabel ? (
            <span
              className={classnames(theme.textLeft, {
                [theme['switch-on']]: checked,
                [theme['switch-off']]: !checked
              })}
            >
              {this.props.leftLabel}
            </span>
          ...
          {this.props.rightLabel ? (
            <span
              className={classnames(theme.textRight, {
                [theme['switch-on']]: checked,
                [theme['switch-off']]: !checked
              })}
            >
